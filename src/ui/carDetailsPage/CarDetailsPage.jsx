...
const CarDetailsPage = () => {
    ...
    const { chartData, averageConsumption, consumptionByCondition, tableRows } =
        useMemo(() => {
            ...
            const chart = [];
            const rowsForTable = sorted.map((l) => ({ ...l, consumption: null }));
    ...
    const handleAddLog = () => {
        ...
        setNewLog({ date: "", liters: "", km: "", price: "", condition: "city" });
    };
        ...
        <div style={{ maxWidth: "900px", margin: "2rem auto", fontFamily: "'Inter', sans-serif" }}>
            ...
            <div style={{ display: "flex", gap: "2rem", marginBottom: "2rem", flexWrap: "wrap" }}>
                ...
                <div style={{ flex: 1 }}>
                    ...
                    <div style={{ marginTop: "0.75rem", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: "0.5rem" }}>
                        ...
                        {conditions.map((cond) => (
                            <div key={cond} style={{ background: "#f8fafc", borderRadius: 8, padding: "8px 10px", borderLeft: `4px solid ${conditionColors[cond]}` }}>
                                <div style={{ fontSize: 12, color: "#64748b", textTransform: "capitalize" }}>{cond} Avg</div>
                            ...
                            <tr key={log._id} style={{ borderBottom: "1px solid #f0f0f0" }}>
                                ...
                                <td>
                                    <button
                                        ...
                                        style={{ padding: "0.25rem 0.5rem", borderRadius: "4px", backgroundColor: "#ef4444", color: "#fff", border: "none", cursor: "pointer" }}
                                    >
                                        Delete
                                    </button>
                                </td>
            ...
            <div style={{ marginTop: "2rem", background: "#fff", padding: "1rem", borderRadius: "12px", boxShadow: "0 4px 12px rgba(0,0,0,0.05)" }}>
                ...
                <div style={{ display: "grid", gap: "0.5rem", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))" }}>
                    ...
                    <input type="number" name="liters" placeholder="Liters" value={newLog.liters} onChange={handleLogChange} />
                    <input type="number" name="km" placeholder="Odometer" value={newLog.km} onChange={handleLogChange} />
                    <input type="number" name="price" placeholder="Price" value={newLog.price} onChange={handleLogChange} />
                ...
                <button
                    ...
                    style={{ marginTop: "1rem", padding: "0.5rem 1rem", backgroundColor: "#10b981", color: "#fff", border: "none", borderRadius: "6px", cursor: "pointer" }}
                >
                    Add Log
                </button>
            </div>
